...
console.log([...arr, ...arr2]); // Doesn't change the original array
...
console.log('caroline'.at(0));
console.log('caroline'.at(-1));
...
const checkDogs = function (dogsJulia, dogsKate) {
  ...
  allDogs.forEach(function (age, i, ar) {
    if (age >= 3) {
...
// Strings
const owners = ['Sarah', 'Caroline', 'Fernanda', 'Valdete'];
...
console.log(
  `Sarah's dog is eating too ${
    dogsSarah.curFood > dogsSarah.recFood * 0.9 ? 'much' : 'little'
  }`
);
